export default function PriceFilter({ price, setFilterOptions }) {
    return (
        <div className="flex flex-col">
            <label htmlFor="price-select" className="block font-medium text-gray-600">Price</label>
            <select value={price} onChange={(e) => setFilterOptions('price', e.target.value)} name="price" id="price-select" className="p-1 border border-gray-30 hover:border-2 hover:border-gray-400 focus:outline-none focus:border-2 focus:border-blue-400 focus:rounded-sm focus:shadow-sm">
